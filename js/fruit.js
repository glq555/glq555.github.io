...
fruitObj.prototype.born = function (i) {
    ...
    if(data.score<3000){
        ...
        }else if(ran<=0.6&&ran>=0.2){
            this.fruitType[i] = "orange";
        }else if(ran<=0.7&&ran>=0.6){
        ...
        if(ran<0.2){
            this.fruitType[i] = "blue";
        }else if(ran<=0.45&&ran>=0.2){
            this.fruitType[i] = "orange";
        }else if(ran<=0.55&&ran>=0.45){
            this.fruitType[i] = "red";
        ...
        if(ran<0.1){
            this.fruitType[i] = "blue";
        }else if(ran<=0.40&&ran>=0.2){
            this.fruitType[i] = "orange";
        }else if(ran<=0.50&&ran>=0.4){
            this.fruitType[i] = "red";
